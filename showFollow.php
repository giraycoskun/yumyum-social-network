  ...
  <div class="container">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        $count = 0;
        foreach ($resultFollowers as $index => $follower) {
          $count = $count + 1; ?>
          <tr>
  ...
  <div class="container">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        $count = 0;
        foreach ($resultFollowering as $index => $followee) {
          $count = $count + 1; ?>
          <tr>
            <th scope="row"><?php echo $count ?></th>
            <td><?php echo $followee['uName'] ?></td>
            <?php if ($checkUser) : ?>
              <td><a class="btn btn-danger" role="button" href="following.php?id=<?php echo $followee['uID'] ?>&action=unfollow&from=profile">Unfollow</a></td>
            <?php endif; ?>
          </tr>
        <?php } ?>
      </tbody>
      ...
      <tbody>
        ...
        foreach ($locations as $loc) {
          ...
          <tr>
            ...
            <?php if ($checkUser) : ?>
              <td><a class="btn btn-danger" role="button" href="following.php?id=<?php echo $loc['locID'] ?>&action=unfollowLoc&from=profile">Unfollow</a></td>
            <?php endif; ?>
          </tr>
        <?php } ?>
      </tbody>
      ...
      <tbody>
        ...
        foreach ($tags as $tag) {
          ...
          <tr>
            ...
            <?php if ($checkUser) : ?>
              <td><a class="btn btn-danger" role="button" href="following.php?id=<?php echo $tag['tagID'] ?>&action=unfollowTag&from=profile">Unfollow</a></td>
            <?php endif; ?>
          </tr>
        <?php } ?>
      </tbody>
