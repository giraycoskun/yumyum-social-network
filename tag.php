    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php if (!$checkFollowLocation) : ?>
                <a href="following.php?id=<?php echo $tagID ?>&action=followTag&from=feed" class="btn btn-primary">Follow</a>
            <?php elseif ($checkFollowLocation) : ?>
                <a href="following.php?id=<?php echo $tagID ?>&action=unfollowTag&from=feed" class="btn btn-secondary">Unfollow</a>
            <?php endif; ?>
        </div>
    </div>
